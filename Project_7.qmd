...
{{< downloadthis resources/imdb.csv label='Download imdb csv file' dname=project_7_data1 icon=folder-fill type=success >}}

{{< downloadthis resources/rotten_tom_ratings.csv label='Download rotten tomatoes csv file' dname=project_7_data2 icon=folder-fill type=success >}}
