...
Using boolean indexing, filter the temperature vector so we are only left with temperatures over 20°C. Your outcome should be the same as seen in @sec-outcometwo. 
