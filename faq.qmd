...
Yes there are solutions. They can be downloaded using the button below. They are a series of script files with multiple approaches to get to the same outcome. 

{{< downloadthis resources/solutions_R.zip label='Download the solutions zip file' dname=solutions_R icon=folder-fill type=success >}}
