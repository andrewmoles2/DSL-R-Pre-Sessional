---
title: "R pre-sessional workshops - Digital Skills Lab"
...
This website provides an introduction to the R pre-sessional workshops run by the Digital Skills Lab (DSL) at LSE. You can navigate this website using the menu on the left, where you can find information about:
...
-   Materials for R pre-sessional workshops
...
![](images/DigitalSkillsLab.png){width="25%" fig-alt="Digital Skills Lab logo"} ![](images/r_logo.png){width="12%" fig-alt="R programming language logo"}
